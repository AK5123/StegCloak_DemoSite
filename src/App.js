        ...
        <div style={{ position: "relative" }} className="wrap-contact100">
          <div style={{ position: "absolute", top: "5px", left: "5px" }}>
            <a
              ...
              data-text="How to Hide Secrets in Strings— Modern Text hiding in JavaScript: https://github.com/KuroLabs/stegcloak"
              data-show-count="true"
              data-url="https://blog.bitsrc.io/how-to-hide-secrets-in-strings-modern-text-hiding-in-javascript-613a9faa5787"
            >
              Tweet
            </a>
            <span style={{ marginLeft: "5px" }}>
              <GitHubButton
                ...
                aria-label="Star kurolabs/stegcloak on GitHub"
              >
                Star
              </GitHubButton>
            </span>
          ...
          <form className="contact100-form validate-form">
            <div style={{ width: "100%", textAlign: "center" }} className="">
              <div>
                ...
                />
                <span className="p-t-15 p-l-10 steg">Steg Cloak</span>
              </div>
            </div>
            ...
            <div className="rs1 next">
              ...
              <div className="wrap-input100 validate-input">
                <input
                  ...
                  type="text"
                  name="first-name"
                  placeholder="World is gonna end!!"
